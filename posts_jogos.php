...
<body>
	...
	<h1 class="my-4 mx-4">
		...
		<?php  
		      	...
		      	$comandoSQL = "SELECT * FROM postagens WHERE aprovacao = 1 AND categoria = 'jogos' "; //traz todos registros do meu banco de dados
		      	...
		      	$comandoSQL = "SELECT * FROM postagens WHERE aprovacao = 1 AND categoria = 'jogos' LIMIT $pagina, $numLinhasPagina"; //LIMIT, o primeiro parametro é apartir da onde, e o outro é quantos eu quero mostrar.
		...
		?>
	  		...
	  		<ul class="pagination" style="margin-left: 34rem;">
	  			...
	  			?>
	  				<li class="page-item"><a class="page-link" href="posts_jogos.php?pagina=<?php echo $i ;?>"><?php echo $i+1; ?></a></li>
